...
const postRoutes = require('./controllers/api/postController'); // Post routes module
const commentRoutes = require('./controllers/api/commentController'); // Comment routes module
...
app.use('/dashboard', commentRoutes);
